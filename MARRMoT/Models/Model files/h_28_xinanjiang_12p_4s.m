classdef h_28_xinanjiang_12p_4s < Hydro_model
...
% Hydrology, 135(1-4), 371-381. http://doi.org/10.1016/0022-1694(92)90096-E
    ...
    methods
        function obj = h_28_xinanjiang_12p_4s()
        ...
        function [dS, fluxes] = model_fun(obj, S)
            ...
            % stores ODEs
            dS1 = flux_pi - flux_e  - flux_r; %W
            dS2 = flux_r  - flux_rs - flux_ri - flux_rg; %S
            dS3 = flux_ri - flux_qi; % Si
            dS4 = flux_rg - flux_qg; % Sg
